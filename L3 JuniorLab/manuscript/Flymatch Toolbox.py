...
#Read User's Guide may provides clues to match picture and how the program works.
...
## File named "*****matchFile.txt" or "*****matchlist.txt" don't contain this sort of data, they are used before matching picture.
